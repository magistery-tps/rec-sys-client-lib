...
Como se puede apreciar, la aplicación esta compuesta por dos grandes partes. [RecSys](https://recsys.ddns.net:8000/) expone un interfaz web para los usuarios finales. Estos puedean realizar y consultar recomemdaciones de items. Por otro lado, [RecSys](https://recsys.ddns.net:8000/) exponen una intarface REST. Esta permite a servicios externos consultar y modificar el modelo de datos de [RecSys](https://recsys.ddns.net:8000/). tambien existent procesos o Jobs que corren en una instancia de [Airflow](https://airflow.apache.org/). Estos Jobs se encargan de consultar las interacciones de los usuarios a [RecSys](https://recsys.ddns.net:8000/) y transformarlas en matrices de similitud user-user/item-item. Finamente actualizan estas similitudes en [RecSys](https://recsys.ddns.net:8000/), para poder realizar recomendaciones al usuario final.



## Componentes

* [RecSys](https://recsys.ddns.net:8000/)
...
**[Amazon Books](https://nijianmo.github.io/amazon/index.html)**: Dataset de libros extraído de Amazon US.
  ...
  * **[data-loading](https://github.com/magistery-tps/rec-sys/blob/main/notebooks/amazon-books/data-loader.ipynb)**
    ...
    *  Carga de datos via SQL en la base de datos de [RecSys](https://recsys.ddns.net:8000/).
  * **[similarity-matrix-jobs](https://github.com/magistery-tps/rec-sys/blob/main/notebooks/amazon-books/distance-matrix-job.ipynb)**
    ...
    * _SurpriseSimilarityMatrixJob_ consulta las interacciones via REST a [RecSys](https://recsys.ddns.net:8000/).
    ...
    * Finalmente, crear o actualiza via REST (En [RecSys](https://recsys.ddns.net:8000/)) las entidades _Recommender_ para cada modelos SVD y NMF, junto con sus propias matrices de similitud (_SimilarityMatrix_, entidades asociada a _Recommender_).
 ...
 * **[data-loader](https://github.com/magistery-tps/rec-sys/blob/main/notebooks/amazon-sneakers/data-loader.ipynb):** Carga de datos en la base de datos de RecSys](https://recsys.ddns.net:8000/) Abstraccion `Repository`.
 ...
 * **[data-loader](https://github.com/magistery-tps/rec-sys/blob/main/notebooks/movielens/data-loader.ipynb):** Carga de datos en la base de datos de RecSys](https://recsys.ddns.net:8000/).

**[RecSys REST client testing](https://github.com/magistery-tps/rec-sys/blob/main/notebooks/api-client-test.ipynb):** Administrar users, items, interacciones y matrices de distancia via [RecSys](https://recsys.ddns.net:8000/) REST API.
...
**Step 9**: Ejecutar notebook [data-loader](https://github.com/magistery-tps/rec-sys/blob/main/notebooks/amazon/data-loader.ipynb): Carga de datos en la base de datos de [RecSys](https://recsys.ddns.net:8000/) Abstraccion `Repository`.
...
## Correr [RecSys](https://recsys.ddns.net:8000/) como servicio [systemd](https://systemd.io/)
